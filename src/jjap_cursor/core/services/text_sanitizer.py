...
# HISTORY: -> 전역에서 재사용 가능한 독립 유틸리티 클래스로 완전히 살점을 찢어 격리 조치 완료.
"""
...
class TextSanitizer:
    """AI가 말귀를 못 알아먹고 섞어놓은 마크다운 특수 기호와 주석 잔재를 싹 쓸어버리는 청소부 클래스입니다."""

    # INFO: =======================================================================
    # INFO: 📜 형님이 하사하신 짭커서 개발 제1보안관 절대 준수 규칙 (상시 열람용)
    # INFO: =======================================================================
    # INFO: 🎛️ On/Off 디버깅 로그 도배 규칙: DEBUG_MODE 스위치로 제어하며, if DEBUG_MODE: 블록을 철저히 구성합니다.
    # INFO: 📝 주석의 엄격한 이원화: 반성문은 # HISTORY:, 친절한 설명은 # INFO:로 마킹합니다.
    # INFO: ⚡ context_builder.py가 정화할 때 # INFO: 및 if DEBUG_MODE: 블록 전체를 도려낼 수 있도록 표적을 명확히 합니다.
    # INFO: =======================================================================
