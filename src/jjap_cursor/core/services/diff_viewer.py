...
class DiffViewer:
    """번역된 트랜잭션 주머니를 열어 원본과 수정본의 격차를 터미널에 빨간줄/파란줄로 그려주는 디자이너 클래스입니다."""

    def __init__(self):
        # INFO: 내장 difflib을 활용하므로 별도의 외부 무거운 라이브러리 의존성 없이 가볍게 구동됩니다.
        pass

    def render(self, transaction: PatchTransaction) -> None:
